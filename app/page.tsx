...
export default function Page() {
  return (
    <main className={`bg-[#001C3D] text-white overflow-x-hidden ${mavenPro.className}`}>
      ...
      <section className="px-10 md:px-20 py-24 bg-[#001C3D]">
        <p className="text-teal-400 text-sm font-semibold tracking-wider uppercase mb-4">
  ...
  {[
    ...
    <div
      key={item.level}
      className={`${item.width} bg-[#001731] border border-[#0a64aa] rounded-xl px-6 py-3 flex items-center justify-between`}
    >
      {/* LEFT TEXT */}
...
<section className="bg-[#EFF4F7] py-24 px-6 md:px-16 text-black">
  {/* HEADER */}
  <p className="text-[#12B9B0] text-sm font-semibold uppercase text-center ">
    Why Milestones
  </p>
  ...
  <p className="mt-7 text-center text-gray-700 text-base">
    ...
    <span className="text-[#12B9B0] font-semibold">
      ...
      <section className="bg-gray-50 text-black py-28 px-10 md:px-20 text-center">
        <p className="text-teal-500 text-sm font-semibold tracking-wider uppercase ">
        ...
        <p className="mt-5 text-teal-500 text-base">Milestones Combines</p>
      ...
      <section className="px-10 md:px-20 py-24 text-center bg-[#001C3D]">
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-10 max-w-6xl mx-auto">
          {[
            ...
            <div key={item} className="flex items-center gap-2 bg-[#0c3c67]  rounded-md px-5 py-2.5">
